...
function UpdateProduct() {
    const { product, setProduct, UpdateProduct1 } = useContext(myContext);
    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            ...
            >
                <h1 className="text-center text-xl font-bold text-gray-800">Update Product</h1>
                ...
                <div className="flex justify-end space-x-3">
                    ...
                    <button
                        type="submit"
                        className="bg-blue-600 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500"
                    >
                        Update Product
                    </button>
                </div>
